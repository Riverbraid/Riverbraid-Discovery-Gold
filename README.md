...
**Lifecycle category:** outer
**Normative source:** Riverbraid-Core
**Claim boundary:** Declared Conditions Only

## Role in Riverbraid

Riverbraid-Discovery-Gold is an outer Gold surface within Riverbraid.

This repository represents the Discovery domain as a visible Riverbraid surface. It helps preserve the shape of discovery-oriented verification and inspection work without implying that this repository currently extends the canonical Evaluation Kit verification floor.

## Public verification boundary

This repository is not part of the current Evaluation Kit canonical verification registry.
