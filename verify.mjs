...
const output = {
  ...
  version: "1.0.0",
  repo: "Riverbraid-Discovery-Gold",
  ring: 1,
  petal: "Discovery-Gold",
  invariant: "DISCOVERY_STATIONARY",
...
if (output.status !== "VERIFIED") {
  console.error("DISCOVERY_GOLD_VERIFICATION_FAILED");
  process.exit(1);
}
console.log("DISCOVERY_GOLD_VERIFICATION_SUCCESS");
